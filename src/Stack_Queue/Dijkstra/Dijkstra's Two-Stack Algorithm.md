 Stack_Queue.Dijkstra's two-stack algorithm is a method for evaluating arithmetic expressions written in infix notation. This is a simplified java implementation of Stack_Queue.Dijkstra's two stack algorithm using an ArrayList.
